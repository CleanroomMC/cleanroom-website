...
::: details name(String name) {id="quote"}
...
::: details recipeFunction(Closure\<ItemStack\> recipeFunction) {open id="quote"}

See the [Recipe Function and Action page](./crafting.md) for more details.

:::

Set the recipe action (optional):

::: details recipeFunction(Closure\<Void\> recipeAction) {id="quote"}
...
::: details replaceByName() {id="quote"}
